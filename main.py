...
TOKEN = "BBUS-PFAVFzcxWyZKw4FBbqXna8jXjLXq31"
DHT_PIN = Pin(15)

UBIDOTS_API_URL = "http://industrial.api.ubidots.com/api/v1.6/devices/" + DEVICE_ID
...
def send_data(temperature, humidity, light):
    data = {"temp": temperature, "humidity": humidity, "ldr_value": light}
    response = requests.post(UBIDOTS_API_URL, json=data, headers=HEADERS)
